       ...
       <Stack.Navigator>
            ...
            <Stack.Screen name='Splash1' component={Splash1}
             options={{
              ...
              <Stack.Screen name='SignupOption1' component={SignupOption1}
             options={{
              title:"",
              headerStyle: { backgroundColor: '#2D665F', height:0},
            }}/>
             <Stack.Screen name='SignupOption2' component={SignupOption2}
             options={{
              title: "",
              headerStyle: { backgroundColor: '#2D665F', height:0},
            }}/>
             <Stack.Screen name='SignupOption3' component={SignupOption3}
             options={{
              title: "",
              headerStyle: { backgroundColor: '#2D665F', height:0},
            }}/>
            <Stack.Screen name='SignupOption4' component={SignupOption4}
             options={{
              title: "",
              headerStyle: { backgroundColor: '#2D665F', height:0},
            }}/>
