    ...
    <View style={[styles.container]}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button} onPress={onPress}>
          <View style={{ flex: 0.5, backgroundColor: "pink" ,justifyContent:'flex-end',alignItems:'center'}}>
            <Image
              source={require("../../assets/images/mail.png")}
              style={styles.imageStyle}
            />
          </View>
          <View style={{ flex: 0.5, backgroundColor: "brown" ,justifyContent:'flex-start',alignItems:''}}>
