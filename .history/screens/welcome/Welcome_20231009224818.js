...
const Welcome = ({ navigation }) => {
  const [loaded] = useFonts({
    ...
    roboto7: require("../../assets/fonts/Roboto/Roboto-Bold.ttf"),
    rubik4: require("../../assets/fonts/rubik/Rubik-Regular.ttf"),
    rubik5: require("../../assets/fonts/rubik/Rubik-Medium.ttf"),
  });
...
const styles = StyleSheet.create({
  ...
  buttonText: {
    ...
    fontSize: 16,
    fontFamily: "rubik5",
    fontWeight: "600", // You can adjust the font weight as needed
  },
  text: {
    width: 278,
    height: 57,
