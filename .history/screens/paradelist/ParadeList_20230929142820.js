...
const ParadeElement = ({ icon, imageSource, label, backgroundColor,navigation }) => {
    const onPress = () => navigation.navigate("ArticleOpened");
  return (
    <TouchableOpacity
      style={[styles.paradeElement, { backgroundColor }]}
      onPress={onPress}
    >
