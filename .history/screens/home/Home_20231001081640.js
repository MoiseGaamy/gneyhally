...
function Screen2({ navigation }) {
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      {/* <Text>Screen 2</Text> */}
      <AiHomeFirst navigation={navigation} />
    </View>
  );
}
function Screen3({navigation}) {
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      <HomeExpertsAuthentification navigation={navigation} />
    </View>
  );
}
...
function CustomDrawerContent({ navigation }) {
  const onPress = () => navigation.navigate("MenuThemeSelected");
  return (
    <SafeAreaView
      style={{
        flex: 1,
...
function TabNavigator({ navigation }) {
  const CustomTabBarIcon = (props) => {
    return (
      <Image
        source={require("../../assets/images/Group.png")} // Replace with the path to your image
        style={{ width: "20%", height: "50%", paddingVertical: "auto" }} // Adjust the width and height as needed
      />
    );
  };
  const CustomTabBarIcon2 = (props) => {
    return (
      ...
      >
        <Image
          source={require("../../assets/images/leaf.png")} // Replace with the path to your image
          style={{ width: "50%", height: "50%", paddingVertical: "auto" }} // Adjust the width and height as needed
        />
      </View>
    );
  };
    ...
    >
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => <CustomTabBarIcon color="green" />,
          // tabBarIcon: () => (
