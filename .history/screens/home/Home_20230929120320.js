...
function TabNavigator({ navigation }) {
  const CustomTabBarIcon = (props) => {
    return (
      <Image
        source={require("../../assets/images/rename.svg")} // Replace with the path to your image
        style={{ width: "28%", height: "28%",tintColor:'yellow' }} // Adjust the width and height as needed
      />
    );
  };
