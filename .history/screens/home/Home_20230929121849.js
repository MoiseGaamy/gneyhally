  ...
  const CustomTabBarIcon = (props) => {
    return (
      <Image
        ...
        style={{ width: "20%", height: "100%", paddingVertical: "auto" }} // Adjust the width and height as needed
      />
    );
  };
    ...
    return (
      ...
      >
        <Image
          ...
          style={{ width: "100%", height: "100%", paddingVertical: "auto" }} // Adjust the width and height as needed
        />
      </View>
    );
  };
