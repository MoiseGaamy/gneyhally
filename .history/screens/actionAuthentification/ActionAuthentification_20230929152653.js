  ...
  return (
    <View style={styles.container}>
      <View style={{ flex: 0.3 }}>
        ...
        >
          <Image
            source={require("../../assets/images/secondCard.png")}
            style={{
              width: "100%",
              height: "100%",
              // top: 188,
      ...
      <TouchableOpacity
        onPress={toggleModal}
        style={{ position: "absolute", top: 80, left: 170 }}
      >
      ...
      <AuthenticationModal visible={modalVisible} closeModal={toggleModal}  navigation={navigation}/>
      <View
        style={{
          flex: 0.1,
          //   justifyContent: "center",
...
export default ActionAuthentication;
