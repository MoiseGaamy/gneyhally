...
const NewDiscussionModal = ({
  ...
  const onPress = console.log("this is just for demo purposes");
  return (
      ...
      <View style={{ flex: 1, height: 60, backgroundColor: "#000000aa" }}>
        ...
        >
          ...
          >
            ...
            <TouchableOpacity style={{ color: "green" ,  width: widthPercentageToDP(`${widthPercentage}%`),
        height: heightPercentageToDP(`${heightPercentage}%`),
        top: 243,
        left: 201,
        borderRadius: 8,
        opacity: 0.35,}} onPress={onPress}>
              {/* <BtnMix
                btnText="Confirmer"
